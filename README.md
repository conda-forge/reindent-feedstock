About reindent-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reindent-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3515&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reindent-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reindent` can be installed with `conda`:
...
```
mamba install reindent
```

It is possible to list all of the versions of `reindent` available on your platform with `conda`:
...
```
mamba search reindent --channel conda-forge
```
...
mamba repoquery search reindent --channel conda-forge

# List packages depending on `reindent`:
mamba repoquery whoneeds reindent --channel conda-forge

# List dependencies of `reindent`:
mamba repoquery depends reindent --channel conda-forge
```
